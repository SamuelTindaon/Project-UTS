    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4 footer-section">
          <h4>Contact Info</h4>
          <ul class="footer-links">
            <li><a href="#"><i class="fas fa-map-marker-alt"></i> Bekasi, Cikarang Selatan</a></li>
            <li><a href="#"><i class="fas fa-phone"></i> +62 859 55142 4577</a></li>
            <li><a href="#"><i class="fas fa-envelope"></i> SamuelTindamatta@gmail.com</a></li>
          </ul>
        </div>
      </div>
